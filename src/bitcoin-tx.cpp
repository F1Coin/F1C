...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("F1coin Core f1coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  f1coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded f1coin transaction") + "\n" +
              "  f1coin-tx [options] -create [commands]   " + _("Create hex-encoded f1coin transaction") + "\n" +
              "\n";
