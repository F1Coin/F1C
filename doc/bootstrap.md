...
### Download the Blockchain from the F1coinNode Project

The F1coin node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by F1coinNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.f1coinnode.org/bootstrap.dat](http://mango.f1coinnode.org/bootstrap.dat)
* [http://apple.f1coinnode.org/bootstrap.dat](http://apple.f1coinnode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.f1coinnode.org/bootstrap.dat](http://bootstrap.f1coinnode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.f1coinnode.org/bootstrap.dat       //downloads bootstrap into current directory
